...
- **High-Inertia Digital PLL**: Grid frequency tracking (45 Hz – 65 Hz) with 10-second sliding frequency averages.
...
- **Bi-Directional 4-Quadrant Energy**: High-resolution `i128` micro-joule (µJ) accumulators for active/reactive energy across Q1–Q4.
...
- **Flickermeter Implementation**: Implementation of Blocks 1–4 flickermeter (SOS Butterworth 35 Hz filter, weighting filter, instantaneous flicker P_inst in realtime; P_st / P_lt classifiers).
